...
function softTop(M) {
  ...
  top.castShadow = true;
  // bow seams deferred to the form pass: the torus drape read as red wires
  // from the follow-cam (2026-08-30 in-engine review) — and the first cut of
  // this deferral also removed the group DECLARATION below the comment it
  // spliced from, killing the whole runtime with "g is not defined"
